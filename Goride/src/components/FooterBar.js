  ...
  import PopupModal from './PopupServices'; // Import PopupModal
    ...
    return (
      <View style={styles.footerBar}>
        ...
        >
          <Svg width={24} height={24} viewBox="0 0 24 24">
            <Path
              ...
              fill={activeTab === 'home' ? "black" : "black"}
            />
          </Svg>
        </TouchableOpacity> 
        ...
        >
          <Svg width={24} height={24} viewBox="0 0 24 24">
            <Path
              ...
              fill={activeTab === 'profile' ? "black" : "black"}
            />
          </Svg>
        </TouchableOpacity>
        ...
        <PopupModal
          ...
          title="Modal Title" // Set appropriate title
          message="This is a message for the modal." // Set appropriate message

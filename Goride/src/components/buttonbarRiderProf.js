...
export default function BottomNavigation({ isTablet }) {
  ...
  const navItems = [
    { name: 'home', label: 'Home', screen: 'LandingPageRider', active: false },
    { name: 'people-outline', label: 'Passenger', screen: 'RidePassenger', active: false },
    { name: 'person-outline', label: 'Profile', screen: 'Rideprofile', active: true },
  ];
